...
//                $this->context->smarty->assign('error', 'Lifetime Of Login Cookie - must be integer number');
            ...
            foreach (array_keys($form_values) as $key) {
                if ($key == 'LEOQUICKLOGIN_ENABLE_URL_GDPR') {
                    Configuration::updateValue($key, str_replace(_PS_BASE_URL_.__PS_BASE_URI__, '', Tools::getValue($key)));
                } else {
...
//            $this->context->smarty->assign('errors', $this->errors);
    ...
    protected function getGroupFieldsValues()
    {
        ...
        $list_value['LEOQUICKLOGIN_ENABLE_URL_GDPR'] = _PS_BASE_URL_.__PS_BASE_URI__.Configuration::get('LEOQUICKLOGIN_ENABLE_URL_GDPR');
    ...
    public function buildQuickLoginForm($layout, $type = '', $enable_sociallogin = '')
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'url_gdpr' => _PS_BASE_URL_.__PS_BASE_URI__.Configuration::get('LEOQUICKLOGIN_ENABLE_URL_GDPR'),
