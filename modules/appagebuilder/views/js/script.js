...
const sliderFirst = $(".slider-product-first .plist-modern");
sliderFirst
  .slick({
    dots: false,
    // speed:500,
...
// sliderFirst.on('wheel', (function(e) {
//   e.preventDefault();
...
const sliderSecond = $(".slider-product-second .plist-modern");
sliderSecond
  .slick({
    dots: false,
    // speed:500,
...
//   sliderSecond.on('wheel', (function(e) {
//   e.preventDefault();
