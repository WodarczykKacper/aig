    ...
    protected function getProducts()
    {
        ...
        if ($this->ajax_search) {
            $searchVariables = array(
                'link' => _PS_BASE_URL_.__PS_BASE_URI__.'index.php?fc=module&module=leoproductsearch&controller=productsearch&cate='.$this->search_cate.'&q='.$this->search_string.'&limit='.Configuration::get('PS_PRODUCTS_PER_PAGE').'&leoproductsearch_static_token='.Tools::getValue('leoproductsearch_static_token'),
